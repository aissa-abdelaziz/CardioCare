...
def main():
    ...
    st.markdown("<h1 style='text-align: center;' class='header'> CardioCare➕</h1>", unsafe_allow_html=True)
    st.markdown("<h5 style='text-align: center;' class='subheader'>A blend of care and technology for personalized heart health support.</h5>", unsafe_allow_html=True)
    ...
    with st.container():
        ...
        image_input = st.file_uploader("Upload Blood Analysis Image", type=["jpg", "png", "jpeg"])
    ...
    st.markdown("<div class='footer' style='text-align: center;'>Powered by CardioCare➕</div>", unsafe_allow_html=True)
